...
client.on('group-participants-update', async (anu) => {
		...
		case 'clone':
					...
					if (args.length < 1) return reply('Tag alvo que você deseja clonar')
					if (mek.message.extendedTextMessage === undefined || mek.message.extendedTextMessage === null) return reply('Ativado')
	...
	client.on('message-new', async (mek) => {
		try {
			...
			mess = {
				wait: '🕧𝗙𝗜𝗚𝗨𝗥𝗔 𝗘𝗠 𝗔𝗡𝗗𝗔𝗠𝗘𝗡𝗧𝗢, 𝗘𝗦𝗣𝗘𝗥𝗘. [•𝗖𝗔𝗦𝗢 𝗡 𝗘𝗡𝗩𝗜𝗘 𝗧𝗘𝗡𝗧𝗘 𝗡𝗢𝗩𝗔𝗠𝗘𝗡𝗧𝗘•]🕣',
				success: '️✔️✅ 𝗙𝗜𝗚𝗨𝗥𝗔 𝗙𝗘𝗜𝗧𝗔 𝗖𝗢𝗠 𝗦𝗨𝗖𝗘𝗦𝗦𝗢',
				error: {
					stick: '❌𝗔𝗟𝗚𝗢 𝗘𝗦𝗧𝗔 𝗘𝗥𝗥𝗔𝗗𝗢 (𝗙𝗔𝗟𝗛𝗔),',
					Iv: '❌𝗟𝗜𝗡𝗞 𝗜𝗡𝗩𝗔𝗟𝗜𝗗𝗢❌'
				},
				only: {
					group: '❬🚫❭ 𝗔𝗣𝗘𝗡𝗔𝗦 𝗗𝗢𝗡𝗢 ',
					...
					Badmin: '❌ 𝗢 𝗕𝗢𝗧 𝗣𝗥𝗘𝗖𝗜𝗦𝗔 𝗦𝗘𝗥 𝗔𝗗𝗠 ;3 '
				}
			}
          ...
          case 'ping':
            ...
            case 'kangcopet':
				...
				case 'info':
					...
					break
				case 'blocklist': 
					teks = '𝗝𝗔 𝗙𝗨𝗜 𝗗𝗔 𝗞𝗔𝗠𝗜𝗞𝗔𝗭𝗘𝗦 :\n'
					for (let block of blocked) {
						teks += `➢ @${block.split('@')[0]}\n`
					}
					teks += `𝗧𝗢𝗧𝗔𝗟 : ${blocked.length}`
			    ...
			    case 'allgc':
					...
					mentions('╔══✪〘𝗖𝗛𝗔𝗠𝗔𝗡𝗗𝗢〙✪══'+teks+'╚═〘𝗭𝗨𝗖𝗞𝗭𝗜𝗡〙', members_id, true)
					break
                case 'hidetag':
					if (!isGroup) return reply(mess.only.group)
                ...
                case 'quotemaker':
                 ...
                 case 'phlogo':
					...
					break
                case 'ninjalogo':
                      if (args.length < 1) return reply('𝗖𝗔𝗗𝗘 𝗢 𝗧𝗘𝗫𝗧𝗢 𝗔𝗡𝗜𝗠𝗔𝗟?')
                      gh = body.slice(11)
                      gl1 = gh.split("|")[0];
                      gl2 = gh.split("|")[1];
                      reply(mess.wait)
                ...
                case 'wolflogo':
                      ...
                      break
                case 'lionlogo':
                      if (args.length < 1) return reply('𝗤𝗨𝗔𝗟 𝗧𝗘𝗫𝗧𝗢 𝗕𝗨𝗥𝗥𝗢???')
                      gh = body.slice(10)
                      gl1 = gh.split("|")[0];
                      gl2 = gh.split("|")[1];
                      reply(mess.wait)
                ...
                case 'nekonime':
				    try {
						...
						client.sendMessage(from, buffer, image, {quoted: mek, caption: '𝗔𝗗𝗢𝗥𝗢 𝗡𝗘𝗞𝗢𝗡𝗜𝗠𝗘'})
					} catch (e) {
                ...
                case 'anjing':
					...
					break
                case 'indohot':
                if (!isNsfw) return reply('𝗔𝗧𝗜𝗩𝗘 𝗢 𝗡𝗦𝗙𝗪')
				...
				break
                case 'kbbi':
					if (args.length < 1) return reply('𝗢𝗤𝗨𝗘 𝗣𝗥𝗢𝗖𝗨𝗥𝗔?')
				...
				case 'ocr': 
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
						...
						reply('𝗘𝗥𝗥𝗢. 𝗘𝗦𝗖𝗢𝗟𝗛𝗔 𝗔 𝗙𝗢𝗧𝗢 ${prefix} 𝗖𝗛𝗨𝗣𝗔')
					}
					break
				case 'stiker': 
				case 'sticker':
            ...
            break	
				case 'gtts':	
				case 'tts':
					if (args.length < 1) return client.sendMessage(from, '𝗣𝗥𝗘𝗖𝗜𝗦𝗔 𝗗𝗘 𝗡𝗗𝗜𝗢𝗠𝗔 !', text, {quoted: mek})
					const gtts = require('./lib/gtts')(args[0])
					if (args.length < 2) return client.sendMessage(from, '𝗞𝗗 𝗢 𝗧𝗘𝗫𝗧𝗢?', text, {quoted: mek})
					dtt = body.slice(9)
					ranm = getRandom('.mp3')
					rano = getRandom('.ogg')
					dtt.length > 300
					? reply('𝗧𝗫𝗧 𝗠𝗨𝗜𝗧𝗢 𝗚𝗥𝗔𝗡𝗗𝗘.')
				...
				case 'setprefix':
					...
					if (!isOwner) return reply(mess.only.ownerB)
					prefix = args[0]
					reply(`𝗣𝗥𝗘𝗙𝗜𝗫𝗢 𝗔𝗟𝗧𝗘𝗥𝗔𝗗𝗢!! : ${prefix}`)
					break 	
				case 'meme': 
					meme = await kagApi.memes()
					buffer = await getBuffer(`https://imgur.com/${meme.hash}.jpg`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '𝘀𝗲𝘂 𝗺𝗲𝗺𝘀.'})
					break
				case 'memeindo': 
			...
			case 'loli': 
				    try {
						...
						console.log(`Error :`, color(e,'red'))
						reply('❌𝗣𝗢𝗟𝗜𝗖𝗜𝗔 𝗠𝗘 𝗣𝗘𝗚𝗢𝗨, 𝗗𝗘𝗦𝗖𝗨𝗟𝗣𝗘❌')
					}
					break
				case 'nsfwloli': 
				    try {
					...
					break
				case 'hilih': 
					if (args.length < 1) return reply('𝗤𝗨𝗔𝗟 𝗧𝗘𝗫𝗧𝗢?')
					anu = await fetchJson(`https://mhankbarbars.herokuapp.com/api/hilih?teks=${body.slice(7)}`, {method: 'get'})
					reply(anu.result)
					break
				case 'tiktokstalk':
					try {
						if (args.length < 1) return client.sendMessage(from, '𝗤𝗨𝗔𝗟 𝗡𝗢𝗠𝗘 𝗗𝗔 𝗣𝗘𝗦𝗦𝗢𝗔??', text, {quoted: mek})
           ...
           case 'demote':
				...
				case 'clone':
					...
					try {
						...
						reply(' *falhei ;(, tente mais tarde dps^_^* ')
					}
					break
				case 'wait':
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
			...
			console.log('Error : %s', color(e, 'red'))
				...
				case 'admsgroup':
					if (!isGroup) return reply(mess.only.group)
					teks = `𝗟𝗜𝗦𝗧𝗔 𝗔𝗗𝗠𝗦 𝗗𝗢 𝗚𝗥𝗨𝗣𝗢*${groupMetadata.subject}*\n𝗧𝗢𝗧𝗔𝗟 : ${groupAdmins.length}\n\n`
					no = 0
					for (let admon of groupAdmins) {
						no += 1
						teks += `[${no.toString()}] @${admon.split('@')[0]}\n`
